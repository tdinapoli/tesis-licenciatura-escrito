...
\fancypagestyle{afterIndex}{%
    ...
    \fancyfoot[LO]{Tésis de licenciatura} % Chapter name on the left for odd pages
    \fancyfoot[RE]{Tésis de licenciatura} % Chapter name on the right for even pages
}
...
\begin{center}
    ...
    \begin{tabular}{|p{7cm}|p{7cm}|}
        ...
        \hline
        \multirow{2}{7cm}[4em]{ Profesor/a de la Tesis de Licenciatura\\Dra. Silvina Ponce Dawson} & \multirow{2}{5cm}[4em]{ Jurado\\ Dr. Alberto F. Scarpettini }\\
        \hline
    \end{tabular}
\end{center}
...
\input{capitulos/protocolos.tex}
